...
it('highlights correct option based on prop value', () => {
  ...
  expect(wrapper.find('#option3').props().className).toEqual('')
  expect(wrapper.find('#option4').props().className).toEqual('')
  wrapper.setProps({ correctOptionIndex: 0 })
  expect(wrapper.find('#option1').props().className).toEqual('highlight_correct')
  expect(wrapper.find('#option2').props().className).toEqual('')
  expect(wrapper.find('#option3').props().className).toEqual('')
  expect(wrapper.find('#option4').props().className).toEqual('')
  wrapper.setProps({ correctOptionIndex: 1 })
  expect(wrapper.find('#option1').props().className).toEqual('')
  expect(wrapper.find('#option2').props().className).toEqual('highlight_correct')
  expect(wrapper.find('#option3').props().className).toEqual('')
  expect(wrapper.find('#option4').props().className).toEqual('')
  wrapper.setProps({ correctOptionIndex: 2 })
  expect(wrapper.find('#option1').props().className).toEqual('')
  expect(wrapper.find('#option2').props().className).toEqual('')
  expect(wrapper.find('#option3').props().className).toEqual('highlight_correct')
  expect(wrapper.find('#option4').props().className).toEqual('')
  wrapper.setProps({ correctOptionIndex: 3 })
  expect(wrapper.find('#option1').props().className).toEqual('')
  expect(wrapper.find('#option2').props().className).toEqual('')
  expect(wrapper.find('#option3').props().className).toEqual('')
